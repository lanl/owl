...
_This document is approved for public release under LA-UR-26-25034._
...
```bash
git clone https://github.com/lanl/owl
cd owl
...
| Parameterization | Names |
|------------------|-------|
| Source inversion | `mt` for six moment-tensor components per shot |
