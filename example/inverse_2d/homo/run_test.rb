...
system "mpirun -np 1 owl_modeling2 param_modeling_low.rb"
system "mpirun -np 1 owl_modeling2 param_modeling_high.rb"

#system "x_suheadstrip <data_#{i}/shot_1_seismogram_p.su >g#{i}.bin; \
		#x_suheadstrip <test_#{i}_dtw/iteration_0/synthetic/shot_1_seismogram_p.su >l#{i}.bin; \
