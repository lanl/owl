...
module elastic_vhtiort_3d
    ...
    type wave_solver_elastic_vhtiort_3d
        ...
        real, allocatable, dimension(:, :, :) :: tieps, tidel, tigam, tithe, tiphi, tieta
    ...
    private
    public :: wave_solver_elastic_vhtiort_3d

end module elastic_vhtiort_3d
